            ...
            <div class="bt_bb_cell">
                  <div class="bt_bb_cell_inner">
                        <div class="widget-content widget-content-area" dir="rtl">
                            ...
                            <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-4" style="margin-right:20px;">
                            ...
                            <div class="col-md-8 col-lg-8 col-sm-8"style="margin-right:20px;";>
                                                            <label  style="margin-right:10px;">كلمة السر</label>
                                                            <input style=" width="150px";"id="password" name="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="كلمة السر" autocomplete="current-password">
                                                            @error('password')
                                                            <span class="invalid-feedback" role="alert">
                                                                  <strong>{{ $message }}</strong>
                                                            </span>
