...
<div class="container-fluid">
      <link rel="stylesheet" href="https://sayer.ae/public/build/css/intlTelInput.css">
      <link rel="stylesheet" href="https://sayer.ae/public/build/css/demo.css">
      <script src="https://sayer.ae/public/build/js/intlTelInput.js"></script>
                  ...
                  <div class="bt_bb_cell">
                        <div class="bt_bb_cell_inner">
                              <div class="widget-content widget-content-area" dir="rtl">
                                    ...
                                    <form class="text-left" method="POST" action="https://sayer.ae/userlogin">
                                          <input type="hidden" name="_token" value="uDNAOEypeRdwfFsJbq7sCzbPqDEG2QIMxMrQkO4K">
                                          <div class="form">
                                                <div class="row">
                                                      <div class="col-md-5">
                                                            <div id="username-field" class="field-wrapper input subscribe-form">
                                                                  ...
                                                                  <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                                                        <div class="iti__flag-container">
                                                                              <div class="iti__selected-flag" role="combobox" aria-owns="iti-0__country-listbox" aria-expanded="false" tabindex="0" title="United Arab Emirates (‫الإمارات العربية المتحدة‬‎): +971" aria-activedescendant="iti-0__item-ae">
                                                                              ...
                                                                              <ul class="iti__country-list iti__hide" id="iti-0__country-listbox" role="listbox">
                                                                                    <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-us-preferred" role="option" data-dial-code="1" data-country-code="us">
                                                                                    ...
                                                                                    <li class="iti__country iti__standard iti__active" tabindex="-1" id="iti-0__item-ae" role="option" data-dial-code="971" data-country-code="ae" aria-selected="true">
                                                                                          <div class="iti__flag-box">
                                                                                                <div class="iti__flag iti__ae"></div>
                                                                        ...
                                                                        </div><input id="phone" type="text" class="form-control " name="phone" value="" autocomplete="phone" autofocus="" dir="ltr" data-intl-tel-input-id="0" style="padding-left: 90px;" placeholder="50 123 4567"><input type="hidden" name="full_number">
                                                                  </div>
                                                            </div>
                                                      </div>
                                                </div>
                                                <div class="row">
                                                      <div class="col-md-5">
                                                            <div id="password-field" class="mb-2 field-wrapper input subscribe-form">
                                                                  <label>كلمة السر</label>
                                                                  <input id="password" name="password" type="password" class="form-control " placeholder="كلمة السر" autocomplete="current-password">
                                                            </div>
                                                      </div>
                                                </div>
                                                <br><br>
                                                <div class="row">
                                                      <div class="col-md-5">
                                                            <div class="password-field">
                                                                  ...
                                                                  <p style="font-family: &quot;Segoe UI&quot;;"> </p>
                                                                  <div class="form-group subscribe-form">
                                                                        <a href="https://sayer.ae/userpassword/reset" class="forgot-pass-link">نسيت كلمة السر ؟</a>
                                                                  </div>
                                                            </div>
                                                      </div>
                                                </div>
