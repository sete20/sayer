            ...
            <div class="bt_bb_cell">
                  <div class="bt_bb_cell_inner">
                        <div class="widget-content widget-content-area" dir="rtl">
                            ...
                            <div class="row">
                            <div class="col-md-8 col-lg-6 col-sm-6" style="margin-right:20px;"><h1>1</h1></div>
                            <div class="col-md-3 col-lg-6 col-sm-6"style="margin-right:20px;">
                                                                                  <div id="password-field" class="mb-2 field-wrapper input subscribe-form">
                                                            <label  style="margin-right:5px;">كلمة السر</label>
