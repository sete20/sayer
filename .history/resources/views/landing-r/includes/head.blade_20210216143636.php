<head>
    ...
    <!-- rtl classes -->
    <link href="{{ asset('bootstrap-rtl.min.css') }}" rel="stylesheet" title="rtlcss">

    <!-- Animate CSS -->
    <link href="{{ asset('animate.css') }}" rel="stylesheet">
    <!-- Icofont CSS -->
    <link href="{{ asset('icofont.css') }}" rel="stylesheet">
    <!-- Owl Carouse CSS -->
    ...
    <!-- "rtl classes" -->
    <link href="{{ asset('custom-rtl.css') }}" rel="stylesheet" title="rtlcss">
   ...
   <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8shuf57BaghqFfPlYxofvL8/KUEfYiJOMMV+rV" crossorigin="anonymous"></script>
    ...
    <script src="{{ asset('js/custom.js') }}"></script>
            ...
            <!-- rtl classes -->
            <link href="{{ asset('css/bootstrap-rtl/bootstrap-rtl.css') }}" rel="stylesheet" />
            <link href="{{ asset('css/bootstrap-rtl/custom-bootstrap-rtl.css') }}" rel="stylesheet" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(function () {
                var $rtl_boostrap = $('link[href="https://cdn.rtlcss.com/bootstrap/v4.3.1/css/bootstrap.min.css"]');
