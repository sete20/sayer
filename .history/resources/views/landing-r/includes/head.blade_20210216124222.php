<head>
    ...
    <!-- rtl classes -->
    <link href="Content/bootstrap-rtl.min.css" rel="stylesheet" title="rtlcss">

    <!-- Animate CSS -->
    <link href="{{ asset('Content/animate.css') }}" rel="stylesheet">
    <!-- Icofont CSS -->
    <link href="{{ asset('Content/icofont.css') }}" rel="stylesheet">
    <!-- Owl Carouse CSS -->
    <link href="{{ asset('Content/owl.carousel.css') }}" rel="stylesheet">
    <!-- Magnific Popup CSS -->
    <link href="{{ asset('Content/magnific-popup.css') }}" rel="stylesheet">
    <!-- Style CSS -->
    <link href="{{ asset('Content/style.css') }}" rel="stylesheet">
    <!-- Responsive CSS -->
    <link href="{{ asset('Content/responsive.css') }}" rel="stylesheet">
    <!-- custom CSS -->
    <link href="{{ asset('Content/custom.css') }}" rel="stylesheet">
    <link href="{{ asset('design/Content/custom.css')}}" rel="stylesheet">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <script src="{{asset('js/custom.js')}}"></script>
            ...
            <!-- rtl classes -->
            <link href="Content/bootstrap-rtl/bootstrap-rtl.css" rel="stylesheet" />
            <link href="Content/bootstrap-rtl/custom-bootstrap-rtl.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(function () {
                var $rtl_boostrap = $('link[href="/Content/bootstrap-rtl.min.css"]');
