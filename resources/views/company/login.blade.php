...
{{--                    <img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/logo-white.svg" alt="Lucid">--}}
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-auth-small" action="{{ route('company.login.post') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="signin-email" class="sr-only control-label">Email Or Phone Number</label>
                                <input type="text" class="form-control" name="credentials" id="signin-email" value="" placeholder="Email Or Phone Number">
                            </div>
                            <div class="form-group">
