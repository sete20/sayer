                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable new_datatable_table">
                            ...
                            <tr>
                                <th>#</th>
                                <th>@lang('admin.state_ar')</th>
                                <th>@lang('admin.state_en')</th>
                            ...
                            <tbody>
                                @foreach($rows as $index=>$row)
                                    <tr>
                                        ...
                                        <td>{{ $row->name_ar }}</td>
                                        <td>{{ $row->name_en }}</td>
                                        <td>{{ $row->country['name_'.App()->getLocale()] }}</td>
                                        ...
                                        <td>
                                            <form action="{{ route('dashboard.' . $model . '.destroy',$row->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('dashboard.' . $model . '.edit',$row->id) }}?country_id={{ $row->country_id }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
