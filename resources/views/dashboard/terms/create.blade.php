                ...
                <div class="body">
                    ...
                    <form action="{{ route('dashboard.'. $model .'.store') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea name="name_ar" class="form-control" rows="5" cols="10" placeholder="@lang('admin.name_ar')" aria-label="Username" aria-describedby="basic-addon1" required></textarea>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.description_en')</span>
                            </div>
                            <textarea name="name_en" class="form-control" rows="5" cols="10" placeholder="@lang('admin.name_en')" aria-label="Username" aria-describedby="basic-addon1" required></textarea>
                        </div>
