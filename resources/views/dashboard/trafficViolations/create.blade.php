            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    @endif
                        ...
                        @if (isset($user_id))
                        <form action="{{ route('dashboard.violations.store',[$id,$user_id]) }}" enctype="multipart/form-data" method="post">
                        @else
                        <form action="{{ route('dashboard.violations.store',$id) }}" enctype="multipart/form-data" method="post">
                        @endif
                        @csrf
                        <div class="row">
                            <div class="mb-3 col-md-4 input-group">
                                ...
                                <input type="text" name="violation_number" class="form-control" value="{{ old('violation_number') }}" placeholder="@lang('admin.violation_number')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="mb-3 col-md-4 input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">@lang('admin.violation_date')</span>
                                </div>
                                <input type="date" name="violation_date" class="form-control" value="{{ old('violation_date') }}" placeholder="@lang('admin.violation_date')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="mb-3 col-md-4 input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">@lang('admin.violation_type')</span>
                                </div>
                                <input type="text" name="violation_type" class="form-control" value="{{ old('violation_type') }}" placeholder="@lang('admin.violation_type')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="mb-3 col-md-6 input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">@lang('admin.violation_area')</span>
                                </div>
                                <input type="text" name="violation_area" class="form-control" value="{{ old('violation_area') }}" placeholder="@lang('admin.violation_area')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="mb-3 col-md-6 input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">@lang('admin.violation_value')</span>
                                </div>
                                <input type="number" name="violation_value" class="form-control" value="{{ old('violation_value') }}" placeholder="@lang('admin.violation_value')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="mb-3 col-md-6 input-group">
                                ...
                                <select name="violation_status" class="form-control">
                            ...
                            <div class="mb-3 col-md-4 input-group">
                                ...
                                <input type="file" name="violation_image" class="form-control" value="{{ old('violation_image') }}" placeholder="@lang('admin.violation_image')" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
