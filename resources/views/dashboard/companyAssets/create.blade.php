                ...
                <div class="body">
                    ...
                    <form action="{{ route('dashboard.'. $model .'.store') }}" method="post">
                        ...
                        <div class="mb-3 input-group">
                            ...
                            <input type="text" name="assetName" class="form-control" value="{{ old('assetName') }}" placeholder="@lang('admin.asset_name')" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.purchase_date')</span>
                            </div>
                            <input type="date" name="purchase_date" class="form-control" value="{{ old('purchase_date') }}" placeholder="@lang('admin.purchase_date')" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.bill_num')</span>
                            </div>
                            <input type="number" name="billNumber" class="form-control" value="{{ old('billNumber') }}" placeholder="@lang('admin.bill_num')" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.supplier')</span>
                            </div>
                            <input type="text" name="supplier" class="form-control" value="{{ old('supplier') }}" placeholder="@lang('admin.supplier')" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.quantity')</span>
                            </div>
                            <input type="number" name="quantity" class="form-control" value="{{ old('quantity') }}" placeholder="@lang('admin.quantity')" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.Specifications')</span>
                            </div>
                            <textarea name="specifications" class="form-control" placeholder="@lang('admin.Specifications')">{{ old('specifications') }}</textarea>
                        </div>
                        <div class="mb-3 input-group">
                            <div class="input-group-prepend">
                            ...
                            <select name="status" class="form-control">
                                <option value="new">@lang('admin.new')</option>
                                <option value="used">@lang('admin.used')</option>
                                <option value="damaged">@lang('admin.damaged')</option>
                                <option value="custody">@lang('admin.custody')</option>
                                <option value="stored">@lang('admin.stored')</option>
                            </select>
                        </div>
