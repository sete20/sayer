                    ...
                    <form action="{{ route('dashboard.'. $model . '.update',$row->id) }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.service_ar')</span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.service_en')</span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">@lang('admin.service_type')</span>
                            </div>
                            <select name="type" class="form-control">
                                <option {{ $row->type == 1 ? 'selected' : '' }} value="1">@lang('admin.local')</option>
                                <option {{ $row->type == 2 ? 'selected' : '' }} value="2">@lang('admin.international')</option>
                            </select>
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
