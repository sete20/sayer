                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable new_datatable_table">
                            ...
                            <tr>
                                <th>#</th>
                                <th>@lang('admin.city_ar')</th>
                                <th>@lang('admin.city_en')</th>
                            ...
                            <tbody>
                                @foreach($rows as $index=>$row)
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->country)
                                                {{ $row->country['name_'.App()->getLocale()] }}
                                            @endif
                                        </td>
                                        @if($row->status == 1)
                                        ...
                                        <td>
                                            <form action="{{ route('dashboard.' . $model . '.destroy',$row->id) }}" method="post">
                                                ...
                                                <a href="" class="btn btn-info"><i class="fa fa-globe"></i></a>
                                                <a href="" class="btn btn-warning"><i class="fa fa-address-book"></i></a>
