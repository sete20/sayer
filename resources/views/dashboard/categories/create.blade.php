                            ...
                            @foreach(config('translatable.locales') as $locale)
                                <div class="tab-pane @if($loop->first) show active @endif" id="{{ $locale }}">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="{{ $locale }}[title]" class="form-control" value="{{ old($locale.'.title') }}" placeholder="@lang('admin.title')" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
