    ...
    <div class="row clearfix">
        <div class="col-lg-3 col-md-6">
            <div class="card top_counter">
                <div class="body">
                    ...
                    <div class="content">
                        <div class="text">@lang('admin.new_clients')</div>
                        <h5 class="number">22</h5>
                    </div>
                    <hr>
                    <div class="icon"><i class="fa fa-users"></i> </div>
                    <div class="content">
                        <div class="text">@lang('admin.events_count')</div>
            ...
            <div class="card top_counter">
                <div class="body">
                    ...
                    <div class="content">
                        <div class="text">@lang('admin.events_money')</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card text-center">
                <div class="body">
                    <h5>@lang('admin.income_analysis')</h5>
                    <span>@lang('admin.last_month')</span>
                    <div class="sparkline-pie m-t-20">6,4,8</div>
                    <div class="stats-report m-b-30">
                        <div class="stat-item">
                            <h5>@lang('admin.admins')</h5>
                            <b class="col-black">84.60%</b></div>
                        <div class="stat-item">
                            <h5>@lang('admin.clients')</h5>
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-hover m-b-0">
                            ...
                            <tbody>
                            <tr>
                                <td><img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/xs/avatar1.jpg" class="rounded-circle width35" alt=""></td>
                            ...
                            <tr>
                                <td><img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/xs/avatar2.jpg" class="rounded-circle width35" alt=""></td>
                                <td>Susie Willis</td>
                            ...
                            <tr>
                                <td><img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/xs/avatar3.jpg" class="rounded-circle width35" alt=""></td>
                            ...
                            <tr>
                                <td><img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/xs/avatar4.jpg" class="rounded-circle width35" alt=""></td>
                                <td>Erin Gonzales</td>
                            ...
                            <tr>
                                <td><img src="{{ url('dashboard') }}/assets-{{ App()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}/images/xs/avatar5.jpg" class="rounded-circle width35" alt=""></td>
                                <td>Ava Alexander</td>
                                <td><span>UI UX Designer</span></td>
                                <td><span class="badge badge-success">Good</span></td>
                                <td><span class="sparkbar">5,8,6,3,5,9,-2</span></td>
