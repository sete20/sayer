...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('admin.userLog')</li>
                </ul>
            </div>
    ...
    <div class="clearfix row">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2>@lang('admin.userLog._table')<small>@lang('admin.table_desc')</small> </h2>
                    <br>
                </div>
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable new_datatable_table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>@lang('admin.logMessage')</th>
                                    <th>@lang('admin.action_by')</th>
                                    <th>@lang('admin.action_for')</th>
                                </tr>
                            </thead>
                            <tfoot>
                            <tr>
